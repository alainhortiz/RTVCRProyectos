 ...
 * FormatoProyecto
 *
 * @ORM\Table(name="formato_proyecto")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\FormatoProyectoRepository")
 */
class FormatoProyecto
{
    /**
     * @var int
     *
    ...
    /**
     * @ORM\OneToMany(targetEntity="Proyecto", mappedBy="formato")
     */
    private $proyectos;
